defmodule FastestMCP.Providers.Skills.OpenCode do
  @moduledoc """
  Builds a default skills-directory provider for OpenCode skill folders.
  ...
  def new(opts \\ []) do
    ...
    SkillsDirectory.new(
      roots: [Path.join(home, ".config/opencode/skills")],
