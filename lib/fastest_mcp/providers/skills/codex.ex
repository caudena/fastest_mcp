defmodule FastestMCP.Providers.Skills.Codex do
  @moduledoc """
  Builds a default skills-directory provider for Codex skill folders.
  ...
  def new(opts \\ []) do
    ...
    system_root = Keyword.get(opts, :system_root, "/etc/codex/skills")

    SkillsDirectory.new(
      roots: [system_root, Path.join(home, ".codex/skills")],
