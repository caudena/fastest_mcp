defmodule FastestMCP.Providers.Skills.Goose do
  @moduledoc """
  Builds a default skills-directory provider for Goose skill folders.
  ...
  def new(opts \\ []) do
    ...
    SkillsDirectory.new(
      roots: [Path.join(home, ".config/agents/skills")],
