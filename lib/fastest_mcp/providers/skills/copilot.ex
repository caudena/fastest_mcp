defmodule FastestMCP.Providers.Skills.Copilot do
  @moduledoc """
  Builds a default skills-directory provider for Copilot skill folders.
  ...
  def new(opts \\ []) do
    ...
    SkillsDirectory.new(
      roots: [Path.join(home, ".copilot/skills")],
